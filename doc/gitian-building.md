...
Clone the git repositories for blockcoin and Gitian.
...
in the blockcoin repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the blockcoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/blockcoin-project/blockcoin
...
For example:
```bash
URL=https://github.com/thrasher-/blockcoin.git
...
[blockcoin-project/gitian.sigs.ltc](https://github.com/blockcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
