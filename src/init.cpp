...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/blockcoin-project/blockcoin>";
    const std::string URL_WEBSITE = "<https://blockcoin.org>";
